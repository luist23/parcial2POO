 ...
 * @author LuisT23
 */
public class Vehiculo1Raza3 extends Vehiculos implements Vehiculo{
    
    public Vehiculo1Raza3(Razas raza) {
        this.raza=raza;
    }
    @Override
...
@Override
    ...
    public String toString() {
        ...
        return  edificioType.VEHICULO1+" "+ raza+" vida: "+vida+"   ataque { edificio: "+ataque[0]+"   milicia: "+ataque[1]+"   vehiculos"+ataque[2]+ " }";
