 ...
 * @author LuisT23
 */
public class EdificioRecurso1 extends Edificios implements Edificio{
    public int recurso;
    public int tasaRecurso;
    
    public EdificioRecurso1(edificioType type){
        this.type=type;
    }
    ...
    public void recogerRecurso(CentroDeMando th) {
        recurso -= th.setRecursos(recurso,0,0)[0];
    }
...
@Override
    ...
    public String costoToString() {
        return edificioType.RECURSO1+"   costo{ "+edificioType.RECURSO1+": "
    ...
    public void setFase(ArrayList<String> mensajes) {
        ...
        if(tiempoespera==0){
            detectable=true;
            mensajes.add(edificioType.RECURSO1+" "+raza+" construido");
        }
    }
        else generarRecurso();
    }
