 ...
 * @author LuisT23
 */
public class EdificioRecurso2 extends Edificios implements Edificio{
    public int recurso;
    public int tasaRecurso;

    public EdificioRecurso2(edificioType type) {
        this.type=type;
    }
    ...
    public void recogerRecurso(CentroDeMando th) {
        recurso -= th.setRecursos(0,recurso,0)[1];
    }
...
@Override
    ...
    public String costoToString() {
        return edificioType.RECURSO2+"   costo{ "+edificioType.RECURSO1+": "
    ...
    public void setFase(ArrayList<String> mensajes) {
        ...
        if(tiempoespera==0){
            detectable=true;
            mensajes.add(edificioType.RECURSO2+" "+raza+" construido");
        }
    }
        else generarRecurso();
    }
