 ...
 * @author LuisT23
 */
public class EspecialistaRaza3 extends Milicias implements Milicia{
    private static EspecialistaRaza3 especialista;
    private static Razas razas;
    private EspecialistaRaza3(){}
    public static EspecialistaRaza3 getInstance(Razas raza){
        if (especialista==null){
            especialista = new EspecialistaRaza3();
            razas=raza;
        }
        return especialista;
    }
