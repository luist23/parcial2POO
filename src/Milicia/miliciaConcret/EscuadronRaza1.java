 ...
 * @author LuisT23
 */
public class EscuadronRaza1 extends Milicias implements Milicia{
    public EscuadronRaza1(Razas raza){
        this.raza=raza;
    }
...
@Override
    ...
    public void setFase(ArrayList<String> mensajes,boolean as) {
        ...
        tiempoespera-=1;//System.out.println(tiempoespera);
        if(tiempoespera==0){
            detectable=true;
            if(as)
            mensajes.add(MiliciaType.ECUADRON+" "+this.raza+" entrenado");
            else
                mensajes.add(MiliciaType.ECUADRON+" "+this.raza+" llego a territorio enemigo");
        }
    }
    ...
    public String toString() {
        ...
        return MiliciaType.ECUADRON +" "+ raza+" vida: "+vida+"   ataque { edificio: "+ataque[0]+"   milicia: "+ataque[1]+"   vehiculos"+ataque[2]+ " }";
    ...
    public String costoToString() {
        return MiliciaType.ECUADRON+"   costo{ "+edificioType.RECURSO1+": "
