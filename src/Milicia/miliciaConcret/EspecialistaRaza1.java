 ...
 * @author LuisT23
 */
public class EspecialistaRaza1 extends Milicias implements Milicia{
    private static EspecialistaRaza1 especialista;
    private static Razas razas;
    private EspecialistaRaza1(){}
    public static EspecialistaRaza1 getInstance(Razas raza){
        if (especialista==null){
            especialista = new EspecialistaRaza1();
            razas=raza;
        }
