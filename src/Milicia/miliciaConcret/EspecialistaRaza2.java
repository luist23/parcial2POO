 ...
 * @author LuisT23
 */
public class EspecialistaRaza2 extends Milicias implements Milicia{
    private static EspecialistaRaza2 especialista;
    private static Razas razas;
    private EspecialistaRaza2(){}
    public static EspecialistaRaza2 getInstance(Razas raza){
        if (especialista==null){
            especialista = new EspecialistaRaza2();
            razas=raza;
        }
        return especialista;
    }
    public static boolean getInstanceExist(){
...
@Override
    ...
    public String getObjetivo() {
        String a="";
        if(objetivoTh!=null){
            a="centro de mando enemigo: vida"+objetivoTh.vida;
        }else if(objetivoEdificio!=null)
    ...
    public void setFase(ArrayList<String> mensajes,boolean as) {
        ...
        if(tiempoespera==0){
            detectable=true;
                        if(as)
            mensajes.add(MiliciaType.ESPECIALISTA+" "+this.raza+" entrenado");
            else
                mensajes.add(MiliciaType.ESPECIALISTA+" "+this.raza+" llego a territorio enemigo");
    ...
    public String toString() {
        ...
        return MiliciaType.ESPECIALISTA +" "+razas+"  "+" vida: "+vida+"   ataque { edificio: "+ataque[0]+"   milicia: "+ataque[1]+"   vehiculos"+ataque[2]+ " }";
    ...
    public String costoToString() {
        return MiliciaType.ESPECIALISTA+"   costo{ "+edificioType.RECURSO1+": "
